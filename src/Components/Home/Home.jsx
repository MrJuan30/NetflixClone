...
const Home = () => {
    ...
    return (
        <div className='w-full h-[550px] content-center text-primary-white 2xl:h-[1000px]'>
            <div className='w-full h-full'>
                <div className='absolute w-full h-[550px] bg-gradient-to-r from-primary-black 2xl:h-[1000px]'></div>
                ...
                <div className='absolute w-full top-[20%] p-4 md:p-8 gap-4  lg:top-[10%] xl:top-[20%]'>
                    ...
                    <br />
                    <p className='font-light w-full md:max-w-[70%] lg:max-w-[50%] 2xl:text-4xl xl:max-w-[45%]  text-primary-white'>{truncateString(movie?.overview, 170)}</p>
                </div>
            </div>
        </div>
    )
