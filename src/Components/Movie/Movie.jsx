    ...
    return (
        <>
            <div className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2'>
                ...
                <div className='absolute flex items-center justify-center top-0 left-0 w-full h-full hover:bg-primary-black/50 opacity-0 hover:opacity-100 text-primary-white'>
